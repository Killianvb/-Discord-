...
module.exports.run = async (bot, message, args) => {
    ...
    if (!message.member.voiceChannel) return message.channel.send("Connect met een spraak kanaal a.u.b.");
 
    if (message.guild.me.voiceChannel) return message.channel.send("Sorry, de bot is al geconnect met een spraak kanaal.");
 
    if (!args[0]) return message.channel.send("Sorry, gelieve een url op te geven.");
